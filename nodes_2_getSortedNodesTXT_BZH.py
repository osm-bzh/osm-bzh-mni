...
# consideredFolder refers to the folder containing the files obtained with nodes_1_getNodesOSM_BZH.py
...
for iIndex in departements:
    listFileNodesBZH.append(consideredFolder + r"\xmlNodes" + iIndex + "_" + date + ".osm")
